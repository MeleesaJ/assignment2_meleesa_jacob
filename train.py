...
random_forest_classifier = RandomForestClassifier(labelCol="quality", featuresCol="features", numTrees=200)
trained_random_forest_model = random_forest_classifier.fit(training_data)

# Model prediction and evaluation
test_predictions = trained_random_forest_model.transform(testing_data)
evaluator = MulticlassClassificationEvaluator(labelCol="quality", predictionCol="prediction", metricName="f1")
f1_score = evaluator.evaluate(test_predictions)
print("Evaluated F1 Score: {:.4f}".format(f1_score))

# Saving the trained model
trained_random_forest_model.save("file:///home/ec2-user/assignment2_meleesa_jacob/trainingweights")
